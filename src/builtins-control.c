...
BUILTIN_UNSPEC(pop, pop, 0, 2)
{
	pop();
}

BUILTIN(get-cont, get_cont, 0, 3)
{
...
BUILTIN_UNSPEC(graft-to-cont, graft_to_cont, 2, 4)
{
...
BUILTIN(return-to-cont, return_to_cont, 2, 5)
{
